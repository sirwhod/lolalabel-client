        ...
        <div className="flex w-full flex-col">
          <div className="flex h-14 w-full bg-lola-yellow-500">
            <div className="flex h-14 w-[70px] items-center justify-center bg-lola-green-500">
              <SmileySad size={40} weight="fill" className="text-green-200" />
            </div>
            <div className="group flex h-14 w-[70px] items-center justify-center bg-lola-yellow-500 hover:bg-lola-orange-500">
              <SmileySad
                size={40}
                weight="fill"
                className="text-yellow-200 group-hover:text-orange-200"
              />
            </div>
            <div className="group flex h-14 w-[70px] items-center justify-center bg-lola-yellow-500 hover:bg-lola-orange-500">
              <SmileySad
          ...
          <div className="relative flex w-full flex-col items-center justify-center gap-4 bg-lola-green-500 px-8 py-20">
            <SmileySad size={128} weight="fill" className="text-green-200" />
            <h1 className="font-anton text-2xl text-green-200">
